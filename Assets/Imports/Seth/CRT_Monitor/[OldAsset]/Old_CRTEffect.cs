...
{
    [ExecuteInEditMode]
    public class Old_CRTEffect : MonoBehaviour
    {
        #region Variables

        public Shader curShader;
        [Range(0.0f, 2.0f)] public float ScreenScale = 0.1f;
        public bool IsLight = false;
        [Range(0.0f, 1.0f)] public float overallLight = 0.0f;
        [Range(0.0f, 1.0f)] public float centerLightScale = 0.0f;
